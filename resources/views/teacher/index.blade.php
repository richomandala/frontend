...
<div class="card">
    ...
    <div class="card-body">
        {!! session('response') !!}
        <a href="{{ route('teacher.create') }}" class="btn btn-primary mb-4">Create</a>
            ...
            <table class="table table-bordered table-hover datatable">
                    ...
                    <tr>
                        {{-- <th class="text-center">
                            <div class="custom-checkbox custom-control">
                                <input type="checkbox" data-checkboxes="teacher" data-checkbox-role="dad"
                ...
                <tbody>
                    ...
                    <tr>
                        {{-- <td>
                            <div class="custom-checkbox custom-control">
                                <input type="checkbox" data-checkboxes="teacher" class="custom-control-input"
                        ...
                        <td class="d-flex">
                            <a href="{{ route('teacher.show', $item['id']) }}" class="btn btn-success mr-2"
                                title="Detail">
                                Detail
                            </a>
                            <a href="{{ route('teacher.edit', $item['id']) }}" class="btn btn-primary mr-2"
                                title="Edit">
                                Edit
                            </a>
                            <form id="form_{{ $loop->iteration }}" action="{{ route('teacher.destroy', $item['id']) }}"
                                method="post">
                                @csrf @method('DELETE')
                            </form>
